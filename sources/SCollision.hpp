...
class s_collision
{
  public:
    ...
    static CollisionResult intersects_aabb_in_aabb(const c_quad &aabb1, const c_quad &aabb2, const c_transform &transform1,
                                     const c_transform &transform2);
    static CollisionResult intersects_sphere_in_aabb(const c_sphere &sphere, const c_quad &aabb, const c_transform &sphere_transform,
                                       const c_transform &aabb_transform);
    static CollisionResult intersects_sphere_in_sphere(const c_sphere &sphere1, const c_sphere &sphere2, const c_transform &transform1,
                                         const c_transform &transform2);
    ...
    static CollisionResult intersects_obb_in_sphere(const c_quad &obb, c_sphere &sphere,
                                        const c_transform &obb_transform, const c_transform &sphere_transform);
