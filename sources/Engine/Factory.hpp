...
class factory
{
  public:
    static unsigned short create_player(registry &registry)
    {
        ...
        registry.add_component<c_transform>(id, c_transform{.position = {0,0,0}, .rotation = {0,0,0}, .scale = {10.0,10.0,10.0}});
    ...
    {
        const auto id = registry.create_entity();
        registry.add_component<c_transform>(id, c_transform{.position = position, .scale = {0.1,0.1,0.1}});
