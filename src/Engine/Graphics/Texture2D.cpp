...
Texture2D::Texture2D(const aiTexture* aiTex)
	: mTextureID(0), mWidth(0), mHeight(0)
{
	// Generate and bind the texture
	GL_CHECK(glGenTextures(1, &mTextureID));
...
Texture2D::Texture2D(GLuint textureID, int width, int height)
{
...
void Texture2D::setShadowSamplerParameters()
{
...
void Texture2D::setNormalSamplerParameters()
{
	bind(31);
